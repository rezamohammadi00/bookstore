function Footer() {
  return (
    ...
    //   </aside>
    // </footer>
    <footer className="footer bg-white text-neutral-content px-10 py-6">
      <aside>
        <svg
          width="50"
          height="50"
        ...
        <p className="text-black leading-normal">
          کلیه حقوق محفوظ است.<br /> طراحی و توسعه توسط
          تیم <span className="text-primary font-bold">کتابان</span>
        </p>
      </aside>
      <nav>
        <h6 className="footer-title text-black">لینک‌ها</h6>
